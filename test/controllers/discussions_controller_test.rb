...
class DiscussionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post :create, discussion: { comment: @discussion.comment, drawover: @discussion.drawover, post_id: @discussion.post_id }
    end
  ...
  test "should update discussion" do
    patch :update, id: @discussion, discussion: { comment: @discussion.comment, drawover: @discussion.drawover, post_id: @discussion.post_id }
    assert_redirected_to discussion_path(assigns(:discussion))
  end
